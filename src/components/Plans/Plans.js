...
export default function Plans({ datacenter, period, tariffs, status, onRetry, }) {
    ...
    return (_jsx("section", { className: styles.plans, "aria-label": "Forex VPS pricing plans", children: _jsx("ul", { className: styles.plans__list, "aria-busy": status === "loading", children: plans.map((plan) => (_jsx("li", { className: styles.plans__item, children: _jsx(PricingCard, { ...plan, specs: selectedSpecs[plan.title] ?? plan.specs, onMenuOptionSelect: (option) => {
