...
export default function PricingCard({ title, price, priceState = "ready", currency = "€", period = "month", specs, terminalsCount, features, tags, featuresLabel = "ВОЗМОЖНОСТИ", tagsLabel = "ПОДХОДИТ ДЛЯ", buyLabel = "КУПИТЬ", terminalsLabel = "Terminals", specDetails, onBuy, onTerminalsHelpClick, isBestChoice = false, bestChoiceLabel = "Best choice", className, }) {
